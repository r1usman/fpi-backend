...
const systemInstruction =
  "You are a highly concise assistant. Answer the user's question in a single, short sentence. Do not elaborate.";
  ...
  while (attempts < maxAttempts) {
    try {
      ...
      if (attempts >= maxAttempts) {
        throw new Error(
          `Failed to query Gemini after ${maxAttempts} attempts: ${error.message}`
        );
      }
